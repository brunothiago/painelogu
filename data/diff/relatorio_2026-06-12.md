# Diferença da base PC 32 - 2026-06-12

- Snapshot atual: `2026-06-12`
- Snapshot anterior: `2026-06-11`
- Total anterior: **1583**
- Total atual: **1583**
...
- Entraram na base: **0**
- Saíram da base: **0**
- Registros com alguma alteração: **45**
- Registros com mudança de dados de origem: **42**
- Registros com mudança apenas em campos derivados/status: **3**

## Mudanças por status

- `status_suspensiva_calc`: **1**
- `status_pub_licitacao_calc`: **4**
- `status_homolog_licitacao_calc`: **0**
- `status_inicio_obra_calc`: **10**
