# Diferença da base PC 32 - 2026-06-19

- Snapshot atual: `2026-06-19`
- Snapshot anterior: `2026-06-16`
- Total anterior: **1613**
- Total atual: **1616**
...
- Entraram na base: **3**
- Saíram da base: **0**
- Registros com alguma alteração: **95**
- Registros com mudança de dados de origem: **92**
- Registros com mudança apenas em campos derivados/status: **3**

## Mudanças por status

- `status_suspensiva_calc`: **2**
- `status_pub_licitacao_calc`: **8**
- `status_homolog_licitacao_calc`: **3**
- `status_inicio_obra_calc`: **15**
- `status_regra_casa_civil_calc`: **0**
- `urgencia_suspensiva_calc`: **2**
- `fase_atual_calc`: **29**
